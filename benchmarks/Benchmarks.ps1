...
$env:bench1 = @($env:outputv2, $env:output7z, $env:outputTar) 
...
$env:output7z = Measure-These -Count $timesToRunEach -ToMeasure {7z a cat.jpg CompressArchiveBenchmarks/file.txt} -AfterEach {rm CompressArchiveBenchmarks/archive.zip} -Titles "7z"
...
$env:outputv2 = Measure-These -Count $timesToRunEach -ToMeasure {Compress-Archive cat.jpg CompressArchiveBenchmarks/archive.tar} -AfterEach {rm CompressArchiveBenchmarks/archive.tar} -Titles "v2 Tar"
$env:bench2 = @($env:outputv2, $env:output7z, $env:outputTar) 
...
$env:output7z = Measure-These -Count $timesToRunEach -ToMeasure {7z a PowerShell CompressArchiveBenchmarks/file.txt} -AfterEach {rm CompressArchiveBenchmarks/archive.zip} -Titles "7z"
...
$env:outputv2 = Measure-These -Count $timesToRunEach -ToMeasure {Compress-Archive PowerShell CompressArchiveBenchmarks/archive.tar} -AfterEach {rm CompressArchiveBenchmarks/archive.tar} -Titles "v2 Tar"
$env:bench3 = @($env:outputv2, $env:output7z, $env:outputTar) 
...
$env:output7z = Measure-These -Count $timesToRunEach -ToMeasure {7z a windows.iso CompressArchiveBenchmarks/file.txt} -AfterEach {rm CompressArchiveBenchmarks/archive.zip} -Titles "7z"
...
$env:outputv2 = Measure-These -Count $timesToRunEach -ToMeasure {Compress-Archive windows.iso CompressArchiveBenchmarks/archive.tar} -AfterEach {rm CompressArchiveBenchmarks/archive.tar} -Titles "v2 Tar"
$env:bench3 = @($env:outputv2, $env:output7z, $env:outputTar) 
...
$env:outputv2 = Measure-These -Count $timesToRunEach -ToMeasure {Expand-Archive CompressArchiveBenchmarks/archive.tar CompressArchiveBenchmarks/bench4} -AfterEach {rm CompressArchiveBenchmarks/bench4/*} -Titles "v2 Tar"
$env:bench4 = @($env:outputv2, $env:output7z, $env:outputTar) 
...
$env:outputv2 = Measure-These -Count $timesToRunEach -ToMeasure {Expand-Archive CompressArchiveBenchmarks/archive.tar CompressArchiveBenchmarks/bench5} -AfterEach {rm CompressArchiveBenchmarks/bench5/*} -Titles "v2 Tar"
$env:bench5 = @($env:outputv2, $env:output7z, $env:outputTar) 
rm CompressArchiveBenchmarks/archive.zip
rm CompressArchiveBenchmarks/archive.tar
...
$env:outputv2 = Measure-These -Count $timesToRunEach -ToMeasure {Expand-Archive CompressArchiveBenchmarks/archive.tar CompressArchiveBenchmarks/bench6} -AfterEach {rm CompressArchiveBenchmarks/bench6/*} -Titles "v2 Tar"
$env:bench6 = @($env:outputv2, $env:output7z, $env:outputTar)
rm CompressArchiveBenchmarks/archive.zip
rm CompressArchiveBenchmarks/archive.tar
...
$env:outputv2 = Measure-These -Count $timesToRunEach -ToMeasure {Expand-Archive CompressArchiveBenchmarks/archive.tar CompressArchiveBenchmarks/bench7} -AfterEach {rm CompressArchiveBenchmarks/bench7/*} -Titles "v2 Tar"
$env:bench7 = @($env:outputv2, $env:output7z, $env:outputTar) 
rm CompressArchiveBenchmarks/archive.zip
rm CompressArchiveBenchmarks/archive.tar
